  ...
  export const face = computed(() => store.getters['deck/getFace'])

  export const increment = ev => store.commit('deck/increment', ev)
  export const decrement = ev => store.commit('deck/decrement', ev)
